...
device.on('connect', function() {
    ...
    // subscribling to 'scalable/pulse-oximeter-sensor/dump' for notficiation about which node to dump too.
    device.subscribe(scalable + deviceName + dump);
    // subscribling to 'scalable/pulse-oximeter-sensor/dump/receive' for notficiation about being the dump node.
...
function getSensorData(deviceName) {
    let message = {
        'pulseOximeterSensor': randomIntBetween(85, 100) // less that 88 is dangerous
    };
