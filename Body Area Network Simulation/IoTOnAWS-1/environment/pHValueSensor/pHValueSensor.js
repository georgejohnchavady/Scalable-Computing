...
device.on('connect', function() {
    ...
    // subscribling to 'scalable/ph-value-sensor/dump' for notficiation about which node to dump too.
    device.subscribe(scalable + deviceName + dump);
    // subscribling to 'scalable/ph-value-sensor/dump/receive' for notficiation about being the dump node.
...
function getSensorData(deviceName) {
    let message = {
        'pHValue': randomFloatBetween(7.25, 7.55) // normal ph value- 7.35 - 7.45
    };
